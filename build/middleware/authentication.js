...
var verifyUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var bearerHeader, decodedToken, sql, rows, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                decodedToken = token_1.default.verifyToken(bearerHeader, process.env.secretkey);
                sql = "SELECT * FROM employees WHERE id = $1";
                return [4 /*yield*/, teamworkModel_1.default.query(sql, [decodedToken.employeeId], res)];
            case 2:
                rows = (_a.sent()).rows;
                if (rows.length === 0) {
